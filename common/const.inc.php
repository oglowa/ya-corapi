...
require_once __DIR__ . '/func-auth.inc.php';
...
CONST REQ_SPACE_LIST         = 'expand=homepage,description.plain,metadata.labels';
...
define('PAGE_MAX_PAGES', 20);
define('PAGE_MAX_RESULTS', PAGE_LIMIT * PAGE_MAX_PAGES);

define('TS_NOW', date('Ymd-His'));
$totalSize  = 0;
$currentPos = 0;
$nextPos    = 0;
...
define('TARGET_DIR', sprintf("%s%s%s%s%s", TARGET_ROOTDIR, DIRECTORY_SEPARATOR, SCRIPT_NAME, DIRECTORY_SEPARATOR, TS_NOW));
...
define('CONF_SPACE_URL', sprintf("%s/rest/api/space", CONF_BASE_URL));

define('WEB_SHOW_PAGEID', sprintf("%s/pages/viewpage.action?pageId=", CONF_BASE_URL));
